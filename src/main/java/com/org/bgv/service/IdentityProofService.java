...
public class IdentityProofService {
    ...
    private DocumentResponse convertToDocumentResponse(IdentityDocuments doc) {
        return DocumentResponse.builder()
                ...
                .doc_type_id(doc.getType_id() != null ? doc.getType_id().getDoc_type_id() : null)
                .document_type_name(doc.getType_id() != null ? doc.getType_id().getName() : null)
                .file_url(doc.getFile_url())
                .file_size(doc.getFile_size())
                .file_name(extractFileName(doc.getFile_url()))
                .file_type(extractFileType(doc.getFile_url()))
