...
public class JobController {
    ...
    public ResponseEntity<ApiResponse<JobPostDTO>> createJob(
        ...
        try {
            ...
            return ResponseEntity.ok(ApiResponse.success("Job created successfully", createdJob, HttpStatus.OK));
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body(ApiResponse.failure("Failed to create job: " + e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR));
        }
    }
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> getCompanyJobs(
        ...
        try {
            ...
            return ResponseEntity.ok(ApiResponse.success("Jobs retrieved successfully", response, HttpStatus.OK));
        } catch (Exception e) {
            log.error("Error fetching jobs for company {}: {}", companyId, e.getMessage(), e);
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body(ApiResponse.failure("Failed to retrieve jobs: " + e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR));
        }
    }
    ...
    public ResponseEntity<ApiResponse<Job>> getJob(
        ...
        try {
            ...
            return ResponseEntity.ok(ApiResponse.success("Job retrieved successfully", job, HttpStatus.OK));
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body(ApiResponse.failure("Failed to retrieve job: " + e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR));
        }
    }
    ...
    public ResponseEntity<ApiResponse<Job>> updateJobStatus(
        ...
        try {
            ...
            return ResponseEntity.ok(ApiResponse.success("Job status updated successfully", updatedJob, HttpStatus.OK));
        } catch (RuntimeException e) {
            log.warn("Job not found with ID: {} for company: {}", id, companyId);
            return ResponseEntity.status(HttpStatus.NOT_FOUND)
                    .body(ApiResponse.failure(e.getMessage(), HttpStatus.NOT_FOUND));
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body(ApiResponse.failure("Failed to update job status: " + e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR));
        }
    }
    ...
    public ResponseEntity<ApiResponse<Map<String, String>>> deleteJob(
        ...
        try {
            ...
            return ResponseEntity.ok(ApiResponse.success("Job deleted successfully", response, HttpStatus.OK));
        } catch (RuntimeException e) {
            log.warn("Job not found with ID: {} for company: {}", id, companyId);
            return ResponseEntity.status(HttpStatus.NOT_FOUND)
                    .body(ApiResponse.failure(e.getMessage(), HttpStatus.NOT_FOUND));
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body(ApiResponse.failure("Failed to delete job: " + e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR));
        }
    }
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> getJobStatistics(
        ...
        try {
            ...
            return ResponseEntity.ok(ApiResponse.success("Job statistics retrieved successfully", statistics, HttpStatus.OK));
        } catch (Exception e) {
            log.error("Error fetching job statistics for company {}: {}", companyId, e.getMessage(), e);
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body(ApiResponse.failure("Failed to retrieve job statistics: " + e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR));
        }
    }

    // Expiring jobs endpoint
    @GetMapping("/expiring")
    public ResponseEntity<ApiResponse<List<Job>>> getExpiringJobs(
            @RequestParam("companyId") Long companyId,
        ...
        try {
            ...
            return ResponseEntity.ok(ApiResponse.success("Expiring jobs retrieved successfully", expiringJobs, HttpStatus.OK));
        } catch (Exception e) {
            log.error("Error fetching expiring jobs for company {}: {}", companyId, e.getMessage(), e);
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body(ApiResponse.failure("Failed to retrieve expiring jobs: " + e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR));
        }
    }
*/
    // Public job details endpoint
    @GetMapping("/public/{id}")
    public ResponseEntity<ApiResponse<Job>> getPublicJob(@PathVariable Long id) {
        ...
        try {
            ...
            if (!"active".equalsIgnoreCase(job.getStatus())) {
                ...
                return ResponseEntity.status(HttpStatus.NOT_FOUND)
                        .body(ApiResponse.failure("Job not found or not active", HttpStatus.NOT_FOUND));
            }
            return ResponseEntity.ok(ApiResponse.success("Job retrieved successfully", job, HttpStatus.OK));
        } catch (RuntimeException e) {
